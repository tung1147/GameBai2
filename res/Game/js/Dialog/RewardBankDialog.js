...
var RewardBankDialog = Dialog.extend({
    ctor : function () {
        ...
        this.dialogNode.addChild(checkBox);
        ...
        this.dialogNode.addChild(checkBoxLabel, 1);
        ...
        this.dialogNode.addChild(listLabel, 1);
        ...
        this.dialogNode.addChild(listButton);
        ...
        this.dialogNode.addChild(textInput1, 2);
        ...
        this.dialogNode.addChild(textInput2, 2);
        ...
        this.dialogNode.addChild(textInput3, 2);
...
var RewardBankList = Dialog.extend({
    ctor : function () {
        ...
        var top = this.dialogNode.getContentSize().height - 178;
        var bottom = 100;
        var left = 100;
        var right = this.dialogNode.getContentSize().width - 100;
        ...
        this.dialogNode.addChild(itemList, 1);
