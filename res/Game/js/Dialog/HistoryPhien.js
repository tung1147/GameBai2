var HistoryPhien = Dialog.extend({
    ctor : function (data) {
        ...
        this.initWithSize(cc.size(987, 600));
        ...
        for(var i=-1; i< 2; i++){
            ...
            xucxac.setPosition(this.getContentSize().width/2 + 120 * i, 404);
        ...
        line_ngang.setPreferredSize(cc.size(this.getContentSize().width, 2));
        ...
        line_ngang1.setPreferredSize(cc.size(this.getContentSize().width, 2));
        ...
        line_doc.setPreferredSize(cc.size(2, 355));
        line_doc.setAnchorPoint(0.5,0);
        line_doc.setPosition(this.getContentSize().width/2, 0);
        ...
        lblTai.setPosition(this.getContentSize().width/2 + 247, 328);
        ...
        lblXiu.setPosition(this.getContentSize().width/2 - 247, 328);
    ...
    _createXiu : function () {
        var mSize = cc.size(485, 265);
        var dx = this.getContentSize().width/2 + 5;
        var thiz = this;
        ...
        var timeLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_20, "Thời gian");
        timeLabel.setColor(cc.color("#24436c"));
        timeLabel.setPosition(dx + 50, 284);
        this.addChild(timeLabel);

        var nameLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_20, "Người chơi");
        nameLabel.setColor(cc.color("#24436c"));
        nameLabel.setPosition(dx + 180, timeLabel.y);
        this.addChild(nameLabel);

        var bettingLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_20, "Cược");
        bettingLabel.setColor(cc.color("#24436c"));
        bettingLabel.setPosition(dx + 310, timeLabel.y);
        this.addChild(bettingLabel);

        var returnLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_20, "Trả lại");
        returnLabel.setColor(cc.color("#24436c"));
        returnLabel.setPosition(dx + 410, timeLabel.y);
        this.addChild(returnLabel);

        var listXiu = new newui.ListViewWithAdaptor(mSize);
        listXiu.setPosition(dx, 0);
    ...
    _createCell : function () {
        ...
        container.setContentSize(cc.size(480, 60));

        var timeLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_18, "time", cc.TEXT_ALIGNMENT_CENTER, 100);
        timeLabel.setPosition(50, 30);
        container.addChild(timeLabel);

        var nameLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_18, "time");
        nameLabel.setPosition(175, timeLabel.y);
        container.addChild(nameLabel);

        var bettingLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_18, "time");
        bettingLabel.setPosition(305, timeLabel.y);
        container.addChild(bettingLabel);

        var returnLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Condensed_18, "time");
        returnLabel.setPosition(405, timeLabel.y);
