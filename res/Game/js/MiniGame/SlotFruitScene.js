...
var POS_BUT_DUP = [{x: 170, y: 79},    {x: 650, y: 79},      {x: 707, y: 220},{x: 592, y: 220},{x: 226, y: 220},{x: 113, y: 220}];
var POS_LAL_DUP = [{x: 170, y: 79},    {x: 650, y: 79},      {x: 707, y: 144},{x: 592, y: 144},{x: 226, y: 144},{x: 113, y: 144}];
...
var SelectLine =  cc.Node.extend({
    ctor:function () {
        ...
        dialogBg.setPreferredSize(cc.size(860,620));
        dialogBg.setAnchorPoint(cc.p(0,0));
        dialogBg.setPosition((cc.winSize.width - 860)/2 , (cc.winSize.height-620)/2);
        this.addChild(dialogBg);

        var dialogBgTitle = new cc.Scale9Sprite("dialog-bg-title.png", cc.rect(20, 0, 4, 60));
        dialogBgTitle.setPreferredSize(cc.size(dialogBg.getContentSize().width, 60));
        dialogBgTitle.setPosition(cc.p(dialogBg.getContentSize().width/2, dialogBg.height - dialogBgTitle.getContentSize().height/2));
        dialogBg.addChild(dialogBgTitle);


        var title = cc.Label.createWithBMFont(cc.res.font.Roboto_CondensedBold_25, "CHỌN DÒNG");
        title.setColor(cc.color("#77cbee"));
        title.setPosition(dialogBg.getContentSize().width/2, dialogBgTitle.getPosition().y);
        ...
        var closeButton = new ccui.Button("dialog-button-close.png","","", ccui.Widget.PLIST_TEXTURE);
        closeButton.setPosition(dialogBg.getContentSize().width - 33.0, title.y);
        ...
        nodeLine.setContentSize(cc.size(860, 440));
        nodeLine.setPosition(dialogBg.width/2,620/2);
        ...
        for(var i = 0; i < 20; i++){
            (function () {
                ...
                var lbl = new cc.LabelBMFont((num+1).toString(), cc.res.font.Roboto_CondensedBold_16);
                lbl.setColor(cc.color("#9cc9e3"));
                bg_num.setTag(1);
        ...
        okChan.setAnchorPoint(cc.p(0.0, 0.5));
        ...
        okChan.setPosition(30,42);

        var okLe = s_Dialog_Create_Button1(cc.size(122, 50), "LẺ");
        okLe.setAnchorPoint(cc.p(0.0, 0.5));
        ...
        okLe.setPosition(160,42);

        var okAll = s_Dialog_Create_Button1(cc.size(122, 50), "TẤT CẢ");
        okAll.setAnchorPoint(cc.p(0.0, 0.5));
...
var DuplicateGold =  cc.Node.extend({
   ctor:function () {
    ...
    initView:function () {
        ...
        bg.setPreferredSize(cc.size(817,597));
        bg.setScale(cc.winSize.screenScale);
        bg.setPosition(cc.winSize.width/2, cc.winSize.height/2);
        this.bg = bg;
        this.addChild(bg);
        var lbl = new cc.LabelBMFont("Đoán màu cây bài để X2 hoặc chất cây bài để X4 tiền thắng. \n                        Chọn nhận thưởng để dừng chơi.",cc.res.font.Roboto_Condensed_25);
        lbl.setPosition(bg.width/2, 445);
        bg.addChild(lbl);
        this.arrButtonBonus = [];
        this.arrLabelBonus = [];
        for(var i = 0; i < 6; i++){
        ...
        bg.addChild(bg_card);
        bg_card.setPosition(bg.width/2,158);

        var cardDefualt = new cc.Sprite("#slot_cardup.png");
        cardDefualt.setPosition(bg.width/2,158);
        ...
        bgTrash.setPosition(bg.width/2,356);
        bg.addChild(bgTrash);
...
var SlotFruitScene = IScene.extend({
    ...
    initView:function () {
        ...
        var title_trial = new cc.Sprite("#slot_title_trial.png");
        title_trial.setPosition(cc.p(582, 656));
        this.bgSlot.addChild(title_trial);
        title_trial.setVisible(false);
        this.title_trial = title_trial;
        ...
        var free_spin = new cc.Sprite("res/slot_free_spin_fore.png");
        free_spin.setAnchorPoint(cc.p(0,0));
        free_spin.setPosition(cc.p(-67, -15));
        ...
        var bg_choithu = new cc.Sprite("res/slot_trial_spin_fore.png");
        bg_choithu.setAnchorPoint(cc.p(0,0));
        bg_choithu.setPosition(cc.p(-67, -15));
...
/*
    ...
    rotateRequestCh:function (index) {
        ...
        if(PlayerMe.gold < this.selectLine.getLines().length*ARR_BET_SLOT[this.indexBet] && !this.isAutoRotate){
    ...
    initLabel:function () {
        ...
        bgHu.setContentSize(cc.size(290, 51));
        bgHu.setPosition(cc.p(504,570));
        ...
        var txtHu = new cc.LabelBMFont("HŨ THƯỞNG: ", cc.res.font.Roboto_CondensedBold_18);
        txtHu.setColor(cc.color("#c1ceff"));
        txtHu.setAnchorPoint(cc.p(1,0.5));
        txtHu.setPosition(142,23);
        bgHu.addChild(txtHu);
        this.txtHu = txtHu;

        var lblHu = new cc.LabelBMFont("10.000", cc.res.font.Roboto_CondensedBold_20);
        lblHu.setColor(cc.color("#ffde00"));
        ...
        // muc cuoc
        var bgBet = new ccui.Scale9Sprite("slot_bg_hu.png",cc.rect(12, 0, 4, 51));
        bgBet.setPreferredSize(cc.size(220, 51));
        bgBet.setPosition(cc.p(504-115,140));
        this.bgSlot.addChild(bgBet);

        var txtBet = new cc.LabelBMFont("CƯỢC :", cc.res.font.Roboto_CondensedBold_18);
        txtBet.setColor(cc.color("#c1ceff"));
        txtBet.setAnchorPoint(cc.p(1,0.5));
        txtBet.setPosition(108,23);
        this.txtBet = txtBet;
        bgBet.addChild(txtBet);

        var lblBet = new cc.LabelBMFont("10.000", cc.res.font.Roboto_CondensedBold_20);
        lblBet.setColor(cc.color("#ffde00"));
        ...
        // tien win
        var bgWin = new ccui.Scale9Sprite("slot_bg_hu.png",cc.rect(12, 0, 4, 51));
        bgWin.setPreferredSize(cc.size(220, 51));
        bgWin.setPosition(cc.p(504+110,140));
        this.bgSlot.addChild(bgWin);

        var txtWin = new cc.LabelBMFont("THẮNG: ", cc.res.font.Roboto_CondensedBold_18);
        txtWin.setColor(cc.color("#c1ceff"));
        txtWin.setAnchorPoint(cc.p(1,0.5));
        txtWin.setPosition(100,23);
        this.txtWin = txtWin;
        bgWin.addChild(txtWin);

        var lblWin = new cc.LabelBMFont("0", cc.res.font.Roboto_CondensedBold_20);
        lblWin.setColor(cc.color("#ffde00"));
        lblWin.setAnchorPoint(cc.p(0,0.5));
        lblWin.setPosition(102,23);
        bgWin.addChild(lblWin);
        this.lblWin = lblWin;

        var lblID = new cc.LabelBMFont("", cc.res.font.Roboto_Condensed_25);
        lblID.setColor(cc.color("#25b9c6"));
    ...
    initBetButtons:function () {
        ...
        play_vitual.addClickEventListener(function () {
            ...
            thiz.title_trial.setVisible(thiz.isTry);
