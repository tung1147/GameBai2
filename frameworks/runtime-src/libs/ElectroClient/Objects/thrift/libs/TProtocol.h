...
//    //T_VIRTUAL_CALL();
 ...
 //   //T_VIRTUAL_CALL();
  ...
  inline TTransport* getTransport() { return ptrans_; }
  ...
  inline TTransport* getInputTransport() { return ptrans_; }
  inline TTransport* getOutputTransport() { return ptrans_; }
...
public:
  ...
  virtual TProtocol* getProtocol(TTransport* trans) = 0;
};
