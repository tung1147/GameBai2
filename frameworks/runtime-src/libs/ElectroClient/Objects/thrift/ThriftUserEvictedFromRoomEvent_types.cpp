 ...
 *  @generated
 */
#include "ThriftUserEvictedFromRoomEvent_types.h"
...
ThriftUserEvictedFromRoomEvent::~ThriftUserEvictedFromRoomEvent() throw() {
}


void ThriftUserEvictedFromRoomEvent::__set_zoneId(const int32_t val) {
  this->zoneId = val;
__isset.zoneId = true;
}

void ThriftUserEvictedFromRoomEvent::__set_roomId(const int32_t val) {
  this->roomId = val;
__isset.roomId = true;
}

void ThriftUserEvictedFromRoomEvent::__set_userName(const std::string& val) {
  this->userName = val;
__isset.userName = true;
}

void ThriftUserEvictedFromRoomEvent::__set_reason(const std::string& val) {
  this->reason = val;
__isset.reason = true;
}

void ThriftUserEvictedFromRoomEvent::__set_ban(const bool val) {
  this->ban = val;
__isset.ban = true;
}

void ThriftUserEvictedFromRoomEvent::__set_duration(const int32_t val) {
  this->duration = val;
__isset.duration = true;
}

uint32_t ThriftUserEvictedFromRoomEvent::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t ThriftUserEvictedFromRoomEvent::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("ThriftUserEvictedFromRoomEvent");
...
ThriftUserEvictedFromRoomEvent::ThriftUserEvictedFromRoomEvent(const ThriftUserEvictedFromRoomEvent& other0) {
...
ThriftUserEvictedFromRoomEvent& ThriftUserEvictedFromRoomEvent::operator=(const ThriftUserEvictedFromRoomEvent& other1) {
...
void ThriftUserEvictedFromRoomEvent::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ThriftUserEvictedFromRoomEvent(";
  ...
  out << ", " << "ban="; (__isset.ban ? (out << to_string(ban)) : (out << "<null>"));
