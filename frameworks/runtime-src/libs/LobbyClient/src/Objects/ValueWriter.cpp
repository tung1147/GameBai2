...
const std::vector<char>& ValueWriter::getBuffer(){
	return mBuffer;
}

void ValueWriter::clear(){
	mBuffer.clear();
}
...
void ValueWriter::write_native_Bytes(const char* bytes, int32_t size){
	mBuffer.insert(mBuffer.end(), bytes, bytes + size);
}

void ValueWriter::write_native_Int8(int8_t value){
	write_native_Bytes((const char*)&value, 1);
}

void ValueWriter::write_native_Int16(int16_t value){
	__writer_swap_bytes((char*)&value, 2);
	write_native_Bytes((const char*)&value, 2);
}

void ValueWriter::write_native_Int32(int32_t value){
	__writer_swap_bytes((char*)&value, 4);
	write_native_Bytes((const char*)&value, 4);
}

void ValueWriter::write_native_Int64(int64_t value){
	__writer_swap_bytes((char*)&value, 8);
	write_native_Bytes((const char*)&value, 8);
}

void ValueWriter::write_native_UInt8(uint8_t value){
	write_native_Bytes((const char*)&value, 1);
}

void ValueWriter::write_native_UInt16(uint16_t value){
	__writer_swap_bytes((char*)&value, 2);
	write_native_Bytes((const char*)&value, 2);
}

void ValueWriter::write_native_UInt32(uint32_t value){
	__writer_swap_bytes((char*)&value, 4);
	write_native_Bytes((const char*)&value, 4);
}

void ValueWriter::write_native_UInt64(uint64_t value){
	__writer_swap_bytes((char*)&value, 8);
	write_native_Bytes((const char*)&value, 8);
}

void ValueWriter::write_native_float(float f){
	__writer_swap_bytes((char*)&f, 4);
	write_native_Bytes((const char*)&f, 4);
}

void ValueWriter::write_native_double(double d){
	__writer_swap_bytes((char*)&d, 8);
	write_native_Bytes((const char*)&d, 8);
}

void ValueWriter::writeNil(){
	write_native_UInt8(0xc0);
}

void ValueWriter::writeBool(bool b){
	if (b){
...
void ValueWriter::writeUint(uint64_t i64){
	if (i64 < 0x7f){ //fix int
...
void ValueWriter::writeFloat(float f){
	write_native_UInt8(0xca);
	write_native_float(f);
}

void ValueWriter::writeDouble(double d){
	write_native_UInt8(0xcb);
	write_native_double(d);
}

void ValueWriter::writeString(const std::string& str){
...
void ValueWriter::writeBin(const char* str, uint32_t size){
	if (size <= UINT8_MAX) {
...
void ValueWriter::writeArray(uint32_t size){
	if (size <= 15){
...
void ValueWriter::writeMap(uint32_t size){
	if (size <= 15){
