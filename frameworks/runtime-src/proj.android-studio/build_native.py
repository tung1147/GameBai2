...
def check_environment_variables():
    ...
    try:
        ...
        #NDK_ROOT = os.environ['NDK_ROOT_r12b']
    except Exception:
        print "NDK_ROOT not defined. Please define NDK_ROOT in your environment"
        #print "NDK_ROOT_r12b not defined. Please define NDK_ROOT_r12b in your environment"
        sys.exit(1)
...
def build(targets,ndk_build_param,build_mode):
    ...
    native_root = os.path.join(project_root, "app")
    ...
    print('build-target: %s'  %targets)
    print('ndk-build-param: %s' %ndk_build_param)
    print('buid-mode: %s' %build_mode)

#    copy_resources(project_root)
    do_build(cocos_root, ndk_root, native_root,ndk_build_param,sdk_root,build_mode)
